...
<div class="ibox float-e-margins">
    ...
    <?php }?>
    <?= Html::beginForm([Url::toRoute('/permission/permissionupdatedone')],'post',['class'=>'form-horizontal']) ?>

    <?= Html::input('hidden','oldname',$model->name)?>
    <div class="ibox-title">
        <h5>更新权限</h5>
        <div class="ibox-tools">
            <a class="collapse-link" title="返回" href="<?php echo Url::to(['permission/permission'])?>" >
