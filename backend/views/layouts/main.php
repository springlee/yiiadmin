...
//    ?>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo Url::to(['user/logout'])?>" >安全退出</a>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<?php echo Url::to(['menu/menu'])?>">菜单列表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="<?php echo Url::to(['menu/menuadd'])?>">添加菜单</a>
                            </li>
                            </li>
                        </ul>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo Url::to(['user/user'])?>">用户列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo Url::to(['user/useradd'])?>">用户添加</a>
                        </li>
                </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?=Url::to(['main/index'])?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
